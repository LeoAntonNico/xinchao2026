...
export default function ReservationsPage() {
  ...
  const flatRows = useMemo(() => {
    const rows: { type: "header"; date: string; count: number } | { type: "row"; reservation: Reservation } = [] as any;
...
out_path = "/Users/openmac/restaurant/src/app/admin/(dashboard)/reservations/page.tsx"
